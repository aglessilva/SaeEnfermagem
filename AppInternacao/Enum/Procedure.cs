namespace AppInternacao.Enum
{
    public enum Procedure
    {
        ...
        SP_ADD_OR_UPDT_EXAME_FISICO_SAE = 55,

        SP_GET_NIC_CLASSIFICACAO = 56,

        SP_GET_NIC_INDICADORES = 57,

        SP_ADD_OR_UPDT_INTERVENCAO_PRESCRICAO_ENFERMAGEM_SAE = 58,

        SP_ADD_OR_UPDT_STATUS_SAE = 59,

        SP_GET_STATUS_SAE = 60,

        SP_GET_EXAME_FISICO_SAE = 61,

        SP_ADD_OR_UPDT_DIAGNOSTICO_ENFERMAGEM_SAE = 62,

        SP_GET_DIAGNOSTICO_ENFERMAGEM_SAE = 63,

        SP_GET_INTERVENCAO_PRESCRICAO_ENFERMAGEM_SAE = 64,

        SP_UPDT_ASSOCIAR_TEMPLATE_EXAME_FISICO = 65,

        SP_GET_NOC_RESULTADO = 66,
