...
{
    public partial class UI009FrmNomeExameFisico : UI000FrmTemplate, ITemplateName
    {
        public UI009FrmNomeExameFisico(TemplateName template = null )
        {
            InitializeComponent();
        ...
        public TemplateName templateName
        {
            ...
            set
            {
                ...
                comboBoxEstruturaFisica.Enabled = value == null || (value.CountExame == null || value.CountExame.Value == 0);
                chkAtivarTemplate.Enabled = value == null || (value.CountExame == null || value.CountExame.Value == 0);
                lblAviso.Visible = !comboBoxEstruturaFisica.Enabled;
                comboBoxEstruturaFisica.SelectedValue = value.IdEstruturaFisica;
                chkAtivarTemplate.Checked = value != null && (value.Ativo ?? false);
            }
        }
        ...
        private void UI009FrmNomeExameFisico_Load(object sender, EventArgs e)
        {
